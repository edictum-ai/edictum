...
Note: `Finding` (the class name) and `findings.py` (the module name) are valid code symbols in the Python SDK. The ban on finding/findings applies to prose and user-facing terminology, not existing code identifiers.
